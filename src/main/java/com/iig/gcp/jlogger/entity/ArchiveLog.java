...
@NamedQuery(
		name = "ArchiveLog.findArchiveDataByProject_idAndFeed_nameAndStart_timeBetween",
		query = "from ArchiveLog s where s.project_id = :project_id and  s.feed_name = :feed_name and s.start_time BETWEEN  :start_date and  :end_date"
		)

@Entity
@Immutable
@Table(name="VIEW_JLOGGER_ARCHIEVE")
